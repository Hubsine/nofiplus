...
use AppBundle\Mailer\TwigSwiftMailer;
...
class EmailConfirmationSubscriber implements EventSubscriberInterface
{
     ...
     */
    public function __construct(TwigSwiftMailer $mailer, TokenGeneratorUtil $tokenGenerator, UrlGeneratorInterface $router, SessionInterface $session)
    {
        $this->mailer           = $mailer;
